...
import { Route as WorldsIdRouteImport } from './routes/worlds/$id'
...
const WorldsIdRoute = WorldsIdRouteImport.update({
  id: '/worlds/$id',
  path: '/worlds/$id',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/worlds/$id': typeof WorldsIdRoute
...
export interface RootRouteChildren {
  ...
  WorldsIdRoute: typeof WorldsIdRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/worlds/$id': {
      ...
      path: '/worlds/$id'
      fullPath: '/worlds/$id'
      preLoaderRoute: typeof WorldsIdRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/worlds/new': {
      id: '/worlds/new'
